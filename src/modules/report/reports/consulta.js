...
MAX(CASE WHEN label = 'Recebimento de NF' THEN pa.iteconforme ELSE '' COLLATE utf8mb4_bin END) AS iteconformeConfNF,
MAX(CASE WHEN label = 'Recebimento de NF' THEN pa.diverconf ELSE '' COLLATE utf8mb4_bin END) AS diverconfConfNF,
